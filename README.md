...
2. In this window, you will be asked to specify the following properties for your toolchain:
 ...
 3. Click on the "Delivery Pipeline" icon. This opens the delivery pipeline settings:
  1. Specify the Bluemix domain for your apps' routes (by default: mybluemix.net).
  2. Specify the build branch you would like your delivery pipelines to build the code from (by default: master).
  3. Specify a unique identifier which must make your apps' names *unique in Bluemix public* (by default: toolchain's creation timestamp).
